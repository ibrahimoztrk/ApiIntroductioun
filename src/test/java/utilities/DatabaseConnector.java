...
public class DatabaseConnector {
    ...
    private static final String dbusername = ConfigurationReader.getProperty("db_oracle_username");
    private static final String dbpassword = ConfigurationReader.getProperty("db_oracle_password");
    private static final String connectionUrl = ConfigurationReader.getProperty("db_oracle_url");
...
//            preparedStatement.setString(1, "New York"); // 1. ? yerine
//            preparedStatement.setInt(2,1); //2. ? yerine
